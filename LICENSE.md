...
are under common control with that entity. For the purposes of this definition,"control" means (i) the power, direct or
...
- **(d)**  If the Work includes a "`NOTICE`" text file as part of its distribution, then any Derivative Works that You
  ...
  a `NOTICE` text file distributed as part of the Derivative Works; within the Source form or documentation, if provided
